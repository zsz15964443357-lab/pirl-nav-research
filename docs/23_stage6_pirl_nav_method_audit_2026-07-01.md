...
- From Stage 7 onward, do not recommit old Stage 4 / Stage 5 review artifacts; keep prior-stage artifacts unchanged, and record cross-stage validation results in the current stage summary or audit.
